// Export DOM Components - Static versions for PNG/PDF export
// These components have NO animations, NO transitions, NO framer-motion
// Fixed A3 landscape dimensions (1587 x auto px)
