    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4 p-4 bg-[#1a1f2e] rounded-xl border border-[#2a3142]">
        <div className="flex items-center gap-2">
          ...
          <label className="text-sm text-gray-300 font-medium">Expenses & Growth</label>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <label className="text-xs text-gray-400">Service Charge (AED/sqft)</label>
              <Input
                type="number"
                value={inputs.serviceChargePerSqft ?? 18}
                onChange={(e) => handleNumberChange('serviceChargePerSqft', e.target.value, 0, 100)}
                className="w-16 h-7 text-right bg-[#0d1117] border-[#2a3142] text-white font-mono text-sm"
              />
            </div>
            <Slider
              value={[inputs.serviceChargePerSqft ?? 18]}
        ...
        {/* ADR Growth (if Airbnb enabled) */}
        {inputs.showAirbnbComparison && (
          <div className="space-y-2 pt-3 border-t border-[#2a3142]">
            <div className="flex justify-between items-center">
              <label className="text-xs text-gray-400">ADR Growth Rate (Airbnb)</label>
