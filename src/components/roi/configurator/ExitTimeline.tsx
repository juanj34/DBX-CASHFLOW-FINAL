...
export const ExitTimeline = ({ 
  ...
  const timelineMarkers = useMemo(() => {
    ...
    // Build markers array imperatively to avoid self-reference issues
    const markers: Array<{
      id: string;
      label: string;
      monthsFromBooking: number;
    ...
    for (let index = 0; index < sortedExits.length; index++) {
      ...
      for (let i = 0; i < index; i++) {
        ...
        // Moderately close (8-15%) - need some stacking  
          ...
          if (prevMarker.labelLevel === labelLevel) {
      ...
      if (index > 0) {
        ...
        if (position - prevMarker.position < 10 && labelLevel === prevMarker.labelLevel) {
          labelLevel = (prevMarker.labelLevel + 1) % 3;
        }
      }
