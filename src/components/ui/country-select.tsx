...
export const CountrySelect = ({ value, onValueChange, placeholder, className }: CountrySelectProps) => {
      ...
      <PopoverTrigger asChild>
        ...
        >
          {selectedCountry ? (
            ...
            <span className="text-muted-foreground">{placeholder || 'Select country...'}</span>
          )}
