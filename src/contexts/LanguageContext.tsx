...
const translations: Translations = {
  ...
  more: { en: 'more', es: 'más' },
  // Payback tooltips
  paybackCalculation: { en: 'Payback Calculation', es: 'Cálculo de Recuperación' },
  totalInvested: { en: 'Total Invested', es: 'Total Invertido' },
  annualIncome: { en: 'Annual Income', es: 'Ingreso Anual' },
  ltCalculation: { en: 'Long-Term Calculation', es: 'Cálculo Largo Plazo' },
  stCalculation: { en: 'Short-Term Calculation', es: 'Cálculo Corto Plazo' },
  ...
  // ====== Snapshot Tab Labels ======
  overviewTabLabel: { en: 'Overview', es: 'Resumen' },
  exitsTabLabel: { en: 'Exits', es: 'Salidas' },
  wealthTabLabel: { en: 'Wealth', es: 'Patrimonio' },
  postHoTabLabel: { en: 'Post-HO', es: 'Post-Entrega' },

  // ====== WealthTab ======
  wealthCreationTitle: { en: 'Wealth Creation', es: 'Generación de Patrimonio' },
  wealthCreationSubtitle: { en: "Track your investment's wealth-building potential through rental income and property appreciation.", es: 'Rastrea el potencial de tu inversión a través de ingresos por renta y apreciación de propiedad.' },
  year1RentalIncomeLabel: { en: 'Year 1 Rental Income', es: 'Ingreso de Renta Año 1' },
  monthlyNetLabel: { en: 'Monthly (Net)', es: 'Mensual (Neto)' },
  annualNetLabel: { en: 'Annual (Net)', es: 'Anual (Neto)' },
  grossColon: { en: 'Gross:', es: 'Bruto:' },
  serviceChargesColon: { en: 'Service charges:', es: 'Cargos de servicio:' },
  netYieldColon: { en: 'Net yield:', es: 'Rendimiento neto:' },
  sevenYearLtVsSt: { en: '7-Year Long-Term vs Short-Term Comparison', es: 'Comparación 7 Años Largo Plazo vs Corto Plazo' },
  sevenYearRentalProjection: { en: '7-Year Rental Projection', es: 'Proyección de Renta a 7 Años' },
  grossRentHeader: { en: 'Gross Rent', es: 'Renta Bruta' },
  airbnbNetHeader: { en: 'Airbnb Net', es: 'Airbnb Neto' },
  winnerHeader: { en: 'Winner', es: 'Ganador' },
  tieLabel: { en: 'Tie', es: 'Empate' },
  yearByYearProjectionTable: { en: 'Year-by-Year Projection Table', es: 'Tabla de Proyección Año por Año' },

  // ====== MortgageTab ======
  mortgageTabSubtitle: { en: 'Evaluate how rental income covers mortgage payments over time and view the complete mortgage breakdown.', es: 'Evalúa cómo los ingresos por renta cubren los pagos de hipoteca y ve el desglose completo.' },
  monthlyMortgageLabel: { en: 'Monthly Mortgage', es: 'Hipoteca Mensual' },
  coverageRatioLabel: { en: 'Coverage Ratio', es: 'Ratio de Cobertura' },
  strongLabel: { en: 'Strong', es: 'Fuerte' },
  moderateLabel: { en: 'Moderate', es: 'Moderado' },
  weakLabel: { en: 'Weak', es: 'Débil' },
  coverageTrendLabel: { en: 'Coverage Trend', es: 'Tendencia de Cobertura' },

  // ====== PostHandoverTab ======
  postHandoverCoverageSubtitle: { en: 'Analyze how rental income covers your post-handover installments. Track cumulative payments vs. rent earned.', es: 'Analiza cómo los ingresos por renta cubren tus cuotas post-entrega. Rastrea pagos acumulados vs. renta obtenida.' },
  postHoTotalLabel: { en: 'Post-HO Total', es: 'Total Post-Entrega' },
  rentEarnedLabel: { en: 'Rent Earned', es: 'Renta Obtenida' },
  netSurplusLabel: { en: 'Net Surplus', es: 'Superávit Neto' },
  netDeficitLabel: { en: 'Net Deficit', es: 'Déficit Neto' },
  postHandoverInstallmentSchedule: { en: 'Post-Handover Installment Schedule', es: 'Cronograma de Cuotas Post-Entrega' },
  numberCol: { en: '#', es: '#' },
  dateCol: { en: 'Date', es: 'Fecha' },
  percentCol: { en: '%', es: '%' },
  amountCol: { en: 'Amount', es: 'Monto' },
  cumPaidCol: { en: 'Cum. Paid', es: 'Acum. Pagado' },
  cumRentCol: { en: 'Cum. Rent', es: 'Acum. Renta' },
  netPositionCol: { en: 'Net Position', es: 'Posición Neta' },
  noPostHandoverInstallments: { en: 'No post-handover installments configured.', es: 'No hay cuotas post-entrega configuradas.' },
  addPostHandoverPaymentsMessage: { en: 'Add post-handover payments in the configurator to see coverage analysis.', es: 'Agrega pagos post-entrega en el configurador para ver el análisis de cobertura.' },

  // ====== SafetyBufferPanel ======
  safetyBufferLabel: { en: 'Safety Buffer', es: 'Colchón de Seguridad' },
  debtServiceCoverageLabel: { en: 'Debt Service Coverage', es: 'Cobertura del Servicio de Deuda' },
  netRentLabel: { en: 'Net Rent', es: 'Renta Neta' },
  debtServiceLabel: { en: 'Debt Service', es: 'Servicio de Deuda' },
  safetyMarginLabel: { en: 'Safety Margin', es: 'Margen de Seguridad' },
  dscrPositiveMessage: { en: 'For every 1 AED of debt, the property generates', es: 'Por cada 1 AED de deuda, la propiedad genera' },
  dscrPositiveMessageSuffix: { en: 'AED of income', es: 'AED de ingreso' },
  dscrModerateMessage: { en: 'Property covers debt with minimal margin', es: 'La propiedad cubre la deuda con margen mínimo' },
  dscrNegativeMessage: { en: 'Property requires additional income to cover debt', es: 'La propiedad requiere ingresos adicionales para cubrir la deuda' },

  // ====== TenantEquityPanel ======
  tenantFundedEquityLabel: { en: 'Tenant-Funded Equity', es: 'Capital Financiado por Inquilino' },
  year10Label: { en: 'Year 10', es: 'Año 10' },
  fullTermLabel: { en: 'Full Term', es: 'Plazo Completo' },
  tenantEquityPitchPrefix: { en: 'Even if the market stays flat, your tenant will pay off', es: 'Aunque el mercado se mantenga estable, tu inquilino pagará' },
  tenantEquityPitchSuffix: { en: 'of your debt — guaranteed exit equity', es: 'de tu deuda — capital de salida garantizado' },

  // ====== StressTestPanel ======
  stressTestLabel: { en: 'Stress Test', es: 'Prueba de Estrés' },
  resilientAllRatesLabel: { en: 'Resilient at All Rates', es: 'Resiliente a Todas las Tasas' },
  reviewHigherRatesLabel: { en: 'Review Higher Rates', es: 'Revisar Tasas Más Altas' },
  currentRateLabel: { en: '(current)', es: '(actual)' },
  debtWord: { en: 'debt', es: 'deuda' },
  stressTestPositiveMsg: { en: 'Property remains cashflow positive even at', es: 'La propiedad mantiene flujo positivo incluso al' },
  stressTestPositiveSuffix: { en: '% interest rate', es: '% de tasa de interés' },
  stressTestNegativeMsg: { en: 'Higher rates may require additional cashflow planning', es: 'Tasas más altas pueden requerir planificación adicional de flujo' },

  // ====== AmortizationTable ======
  amortizationScheduleLabel: { en: 'Amortization Schedule', es: 'Tabla de Amortización' },
  yearsParenLabel: { en: 'Years', es: 'Años' },
  principalHeader: { en: 'Principal', es: 'Principal' },
  interestHeader: { en: 'Interest', es: 'Interés' },
  balanceHeader: { en: 'Balance', es: 'Saldo' },
  equityPercentHeader: { en: 'Equity %', es: 'Capital %' },
  totalOverYearsLabel: { en: 'Total over', es: 'Total en' },
  yearsColon: { en: 'years:', es: 'años:' },
  principalTotalLabel: { en: 'Principal:', es: 'Principal:' },
  interestTotalLabel: { en: 'Interest:', es: 'Interés:' },

  // ====== ExitScenariosCards - additional keys ======
  contractPriceLabel: { en: 'Contract Price', es: 'Precio de Contrato' },
  entryCostsLabel: { en: 'Entry Costs', es: 'Costos de Entrada' },
  dldFeesShortLabel: { en: 'DLD + Fees', es: 'DLD + Tarifas' },
  timelineLabel: { en: 'Timeline', es: 'Cronograma' },
  toHandoverLabel: { en: 'to handover', es: 'hasta entrega' },
  excellentLabel: { en: 'Excellent', es: 'Excelente' },
  goodLabel: { en: 'Good', es: 'Bueno' },
  fairLabel: { en: 'Fair', es: 'Regular' },
  lowLabel: { en: 'Low', es: 'Bajo' },
  earlyStructureLabel: { en: 'Early Structure', es: 'Estructura Temprana' },
  fiftyPercentCompleteLabel: { en: '50% Complete', es: '50% Completo' },
  structureCompleteLabel: { en: 'Structure Complete', es: 'Estructura Completa' },
  toppingOutLabel: { en: 'Topping Out', es: 'Coronación' },
  handoverReadyLabel: { en: 'Handover Ready', es: 'Listo para Entrega' },
  growthPhaseLabel: { en: 'Growth Phase', es: 'Fase de Crecimiento' },
  maturePhaseLabel: { en: 'Mature Phase', es: 'Fase Madura' },
  returnOnCashInvestedLabel: { en: 'Return on Cash Invested', es: 'Retorno sobre Capital Invertido' },
  profitToPocketLabel: { en: 'Profit to Pocket', es: 'Ganancia Neta' },
  profitToPocketNetLabel: { en: '(Net)', es: '(Neto)' },
  cashAtExitLabel: { en: 'Cash at Exit', es: 'Efectivo al Salir' },
  exitValueLabel: { en: 'Exit Value', es: 'Valor de Salida' },
  basePriceLabel: { en: 'Base Price', es: 'Precio Base' },
  hideBreakdownLabel: { en: 'Hide Breakdown', es: 'Ocultar Desglose' },
  cashDeployedLabel: { en: 'Cash Deployed', es: 'Capital Desplegado' },
  totalInvestedLabel: { en: 'Total Invested', es: 'Total Invertido' },
  agentCommissionLabel: { en: 'Agent (2%)', es: 'Agente (2%)' },
  nocFeeLabel: { en: 'NOC Fee', es: 'Tasa NOC' },

  // ====== OIGrowthCurve - additional keys ======
  underConstructionPhaseLabel: { en: 'Under Constr.', es: 'En Constr.' },
  postHandoverPhaseLabel: { en: 'Post-HO', es: 'Post-Entrega' },
  maturityPhaseLabel: { en: 'Maturity', es: 'Madurez' },
  roeAbbr: { en: 'ROE', es: 'ROE' },
  handoverValueLabel: { en: 'Handover Value', es: 'Valor en Entrega' },
  exitLabel: { en: 'Exit', es: 'Salida' },

  // ====== OIYearlyProjectionTable - additional keys ======
  propertyValueRentalYieldSubtitle: { en: 'Property value & rental yield across phases', es: 'Valor de propiedad y rendimiento de renta por fases' },
  longTermRentalHeader: { en: 'Long-Term Rental', es: 'Renta a Largo Plazo' },
  shortTermRentalHeader: { en: 'Short-Term Rental', es: 'Renta a Corto Plazo' },

  // ====== InvestmentJourneyCards - additional keys ======
  strategyWinnerLabel: { en: 'Strategy Winner', es: 'Estrategia Ganadora' },
  shortTermRentalWinner: { en: 'Short-Term Rental', es: 'Renta a Corto Plazo' },
  longTermRentalWinner: { en: 'Long-Term Rental', es: 'Renta a Largo Plazo' },
  moreThanLongTermOver10Years: { en: 'more than Long-Term over 10 years', es: 'más que Largo Plazo en 10 años' },
  stableIncomeWithLongTerm: { en: 'more stable income with Long-Term strategy', es: 'ingresos más estables con estrategia a Largo Plazo' },
  investmentOverviewLabel: { en: 'Investment Overview', es: 'Resumen de Inversión' },
  todayLabel: { en: 'Today', es: 'Hoy' },
  targetLabel: { en: 'Target', es: 'Objetivo' },
  theBuildCardTitle: { en: 'The Build', es: 'La Construcción' },
  yearsRange: { en: 'Years', es: 'Años' },
  capitalGrowthLabel: { en: 'Capital Growth', es: 'Crecimiento de Capital' },
  constructionPhaseAppreciationLabel: { en: 'Construction Phase Appreciation', es: 'Apreciación en Fase de Construcción' },
  offPlanAppreciationExplanation: { en: 'Off-plan properties typically appreciate during construction as the project progresses and risk decreases.', es: 'Las propiedades sobre plano típicamente se aprecian durante la construcción a medida que avanza el proyecto y disminuye el riesgo.' },
  perYearLabel: { en: 'per year', es: 'por año' },
  valueAtHandoverColonLabel: { en: 'Value at handover:', es: 'Valor en entrega:' },
  buildPhaseExplanation: { en: 'Property appreciates while under construction. No rental income yet.', es: 'La propiedad se aprecia durante la construcción. Sin ingresos de renta aún.' },
  theHandoverCardTitle: { en: 'The Handover', es: 'La Entrega' },
  firstFullYearRentLabel: { en: 'First Full Year Rent', es: 'Renta del Primer Año Completo' },
  firstYearRentExplanationPrefix: { en: 'Annual rental income for', es: 'Ingreso anual por renta para' },
  firstYearRentExplanationSuffix: { en: '(first complete 12-month period after handover).', es: '(primer período completo de 12 meses después de la entrega).' },
  handoverPhaseExplanation: { en: 'Keys collected! Start earning rental income.', es: '¡Llaves recibidas! Comienza a generar ingresos por renta.' },
  theCashflowEngineTitle: { en: 'The Cashflow Engine', es: 'El Motor de Flujo de Caja' },
  yearsOfRental: { en: 'years of rental', es: 'años de renta' },
  totalProfitLtLabel: { en: 'Total Profit (LT)', es: 'Ganancia Total (LP)' },
  totalProfitStLabel: { en: 'Total Profit (ST)', es: 'Ganancia Total (CP)' },
  avgPerYearLabel: { en: '/year', es: '/año' },
  stWinsByLabel: { en: 'ST wins by', es: 'CP gana por' },
  ltWinsByLabel: { en: 'LT wins by', es: 'LP gana por' },

  // ====== MortgageBreakdown - additional keys ======
  financingAnalysisLabel: { en: 'Financing Analysis', es: 'Análisis de Financiamiento' },
  cashShortfallLabel: { en: 'Cash Shortfall', es: 'Déficit de Efectivo' },
  cashShortfallExplanationPrefix: { en: 'Payable at handover — Bank requires', es: 'Pagadero en la entrega — El banco requiere' },
  cashShortfallExplanationMiddle: { en: '% equity, you pay', es: '% de capital, tú pagas' },
  cashShortfallExplanationSuffix: { en: '% pre-handover', es: '% pre-entrega' },
  gapPercentLabel: { en: 'Gap:', es: 'Brecha:' },
  bankGovFeesLabel: { en: 'Bank & Gov Fees', es: 'Gastos Bancarios y Gov.' },
  totalMonthlyWithInsuranceLabel: { en: 'Total Monthly (+ Insurance)', es: 'Total Mensual (+ Seguro)' },
  surplusLabel: { en: 'surplus', es: 'excedente' },
  clickForBreakdownLabel: { en: 'Click for breakdown', es: 'Clic para desglose' },
  grossMonthlyRentLabel: { en: 'Gross Monthly Rent', es: 'Renta Mensual Bruta' },
  minusServiceChargesLabel: { en: '− Service Charges', es: '− Cargos de Servicio' },
  finalCashflowLabel: { en: 'Final Cashflow', es: 'Flujo de Caja Final' },
  mortgageCoveredLabel: { en: 'Mortgage Covered', es: 'Hipoteca Cubierta' },

  // ====== RentSnapshot - additional keys ======
  yieldIncomeLabel: { en: 'Yield & Income', es: 'Rendimiento e Ingresos' },
  avgAnnualRentLabel: { en: 'Avg. Annual Rent', es: 'Renta Anual Promedio' },
  sevenYearAvgWithGrowth: { en: '7-year avg.', es: 'Promedio 7 años' },
  yrGrowthLabel: { en: '/yr growth', es: '/año crecimiento' },
  netYieldAfterChargesLabel: { en: 'Net Yield After Charges', es: 'Rendimiento Neto Después de Cargos' },
  shortTermComparisonLabel: { en: 'Short-Term Comparison', es: 'Comparación Corto Plazo' },
  scenarioModeActiveLabel: { en: 'Scenario Mode Active', es: 'Modo Escenario Activo' },
  occupancyLabel: { en: 'Occupancy', es: 'Ocupación' },
  resetToDefaultLabel: { en: 'Reset to Default', es: 'Restablecer Valores' },
  averageDailyRateLabel: { en: 'Average Daily Rate', es: 'Tarifa Diaria Promedio' },
  grossAnnualLabel: { en: 'Gross Annual', es: 'Bruto Anual' },
  operatingExpensesLabel: { en: 'Operating Expenses', es: 'Gastos Operativos' },
  utilitiesAndUpkeepLabel: { en: 'Utilities and Upkeep', es: 'Servicios y Mantenimiento' },
  managementFeeLabel: { en: 'Management Fee', es: 'Comisión de Gestión' },
  netAnnualLabel: { en: 'Net Annual', es: 'Neto Anual' },
  incomeComparisonLabel: { en: 'Income Comparison', es: 'Comparación de Ingresos' },
  differenceVsLongTerm: { en: 'vs Long-Term', es: 'vs Largo Plazo' },
  paybackPeriodLabel: { en: 'Payback Period', es: 'Período de Recuperación' },

  // ====== Payment Breakdown Option 2 (PDF-style) ======
  initialCostSectionLabel: { en: 'A. Initial Cost', es: 'A. Costo Inicial' },
  holdingFeeLabel: { en: 'Holding Fee', es: 'Cuota de Reserva' },
  signedPurchaseAgreementLabel: { en: 'Signed Purchase Agreement', es: 'Contrato de Compra Firmado' },
  dubaiLandDeptFeeLabel: { en: 'Dubai Land Department Fee', es: 'Tarifa del Departamento de Tierras de Dubai' },
  oqoodFeesLabel: { en: 'Oqood Fees (Pre title deed)', es: 'Oqood (Pre escritura)' },
  adminFeeLabel: { en: 'Admin Fee', es: 'Tarifa Admin' },
  paymentOnReservationLabel: { en: 'Payment on Reservation and Exchange', es: 'Pago en Reserva e Intercambio' },
  milestoneEventSectionLabel: { en: 'B. Milestone Event', es: 'B. Evento de Hito' },
  installmentWithNumber: { en: 'Installment', es: 'Cuota' },
  monthsAfterBookingLabel: { en: 'Months after Booking Date', es: 'Meses después de la Fecha de Reserva' },
  onProjectCompletion: { en: 'On % of Project Completion', es: 'Al % de Finalización del Proyecto' },
  paymentOnCompletionLabel: { en: 'Payment On Completion', es: 'Pago al Completar' },
  estimatedLabel: { en: 'Estimated', es: 'Estimado' },
  totalEquityRequiredLabel: { en: 'Total Equity Required', es: 'Capital Total Requerido' },
  projectMonthlyNetIncomeSectionLabel: { en: 'C. Project Monthly Net Income', es: 'C. Ingreso Mensual Neto del Proyecto' },
  estimatedGrossMonthlyRentalLabel: { en: 'Estimated Gross Monthly Rental Income', es: 'Ingreso Bruto Mensual Estimado por Renta' },
  serviceChargePsftLabel: { en: 'Service charge (PSFT)', es: 'Cargo de servicio (PSFT)' },
  netMonthlyIncomeLabel: { en: 'Net Monthly Income', es: 'Ingreso Mensual Neto' },
  perMonthLabel: { en: 'Per month', es: 'Por mes' },
  ofPurchasePriceLabel: { en: 'of Purchase Price', es: 'del Precio de Compra' },
  ofPropertyValueLabel: { en: 'of Property Value', es: 'del Valor de Propiedad' },
  annualNetCashPositionLabel: { en: 'Annual Net Cash Position', es: 'Posición Neta Anual de Efectivo' },
  projectedROILabel: { en: 'Projected ROI', es: 'ROI Proyectado' },
  salesPriceLabel: { en: 'Sales Price', es: 'Precio de Venta' },
  acceptedCurrenciesNote: { en: 'Accepted currencies AED only. Other currencies spot rate from time of issue and subject to change.', es: 'Solo se aceptan monedas AED. Las demás divisas a tasa del momento de emisión y sujetas a cambio.' },
  additionalNotesLabel: { en: 'Additional Notes', es: 'Notas Adicionales' },
  paymentBreakdownOption2Label: { en: 'Payment Breakdown (Detailed)', es: 'Desglose de Pagos (Detallado)' },
  switchToOption1: { en: 'Simple View', es: 'Vista Simple' },
  switchToOption2: { en: 'Detailed View', es: 'Vista Detallada' },

  // ====== Additional missing keys ======
  exitStrategyLabel: { en: 'Exit Strategy', es: 'Estrategia de Salida' },
  viewBreakdownLabel: { en: 'View Breakdown', es: 'Ver Desglose' },
  postHandoverBadgeLabel: { en: 'Post-Handover', es: 'Post-Entrega' },
  percentBuiltSuffix: { en: 'built', es: 'construido' },
  perYearSuffix: { en: '/year', es: '/año' },
  plusEntryCostsLabel: { en: '+ Entry Costs', es: '+ Costos de Entrada' },
  exitPriceLabel: { en: 'Exit Price', es: 'Precio de Salida' },
  grossProfitLabel: { en: 'Gross Profit', es: 'Ganancia Bruta' },
  priceAppreciationLabel: { en: 'Price Appreciation', es: 'Apreciación de Precio' },
  viewColonLabel: { en: 'View:', es: 'Ver:' },
  cumulativeNetRentalIncomePrefix: { en: 'Cumulative net rental income over', es: 'Ingreso neto acumulado de renta en' },
  yearsWithStrategyAvg: { en: 'years with', es: 'años con estrategia' },
  strategyAvgSuffix: { en: 'strategy. Avg:', es: '. Promedio:' },
